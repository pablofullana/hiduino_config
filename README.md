...
2. Make sure bundler gem is installed. Hint: <tt>gem install bundler</tt>


=== Installation
Install the application by running: bundle install
...
2. Expose application portby running: <tt>ngrok 3000</tt>
